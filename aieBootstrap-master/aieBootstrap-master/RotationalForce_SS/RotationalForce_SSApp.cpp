...
RotationalForce_SSApp::RotationalForce_SSApp() {
...
void RotationalForce_SSApp::SetupConinuousDemo(glm::vec2 startPos, float inclination, float speed, float gravity)
{
	float t = 0;
	float timeStep = 0.1f;
	float radius = 1.0f;
...
void RotationalForce_SSApp::SetupNumericalIntergration(vec2 startPos, vec2 velocity, vec2 force, float inclination)
{
	float t = 0;
...
bool RotationalForce_SSApp::startup() {
...
void RotationalForce_SSApp::shutdown() {

	delete m_font;
	delete m_2dRenderer;
}

void RotationalForce_SSApp::update(float deltaTime) {
...
void RotationalForce_SSApp::draw() {
